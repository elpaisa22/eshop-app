System.register(['@angular/core', '@angular/router', '../../models/product/product.model', '../../repositories/product/product.repository', '../../services/cart/cart.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, product_model_1, product_repository_1, cart_service_1;
    var DetailComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            DetailComponent = (function () {
                ...
                DetailComponent = __decorate([
                    core_1.Component({
                        ...
                        providers: [product_repository_1.ProductRepository, cart_service_1.CartService]
                    }), 
                    __metadata('design:paramtypes', [router_1.Router, product_repository_1.ProductRepository, cart_service_1.CartService])
                ], DetailComponent);
